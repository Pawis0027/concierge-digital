...
let imgsCarrousel = document.querySelectorAll(".carrousel-restaurante .div-imagenes-scroll img");
let imgCarrouselActiva = false;
let primeravez = true;
let numImgActual;
let imgSelec = document.querySelector(".carrousel-restaurante-div-fondo .imgSelec");
let divImgSelec = document.querySelector(".carrousel-restaurante-div-fondo");
let imgSelecSig = document.querySelector(".carrousel-restaurante-div-fondo .sig");
let imgSelecPrev = document.querySelector(".carrousel-restaurante-div-fondo .prev");

for (let i = 0; i < imgsCarrousel.length; i++) {
    let imgCarrousel = imgsCarrousel[i];
...
function expandirImg(imgCarrousel, numImgActual) {
    ...
    let cerrarImg = document.querySelector(".carrousel-restaurante-div-fondo .btn-back");
...
//   --------------abrir menu
let menu = document.querySelector(".carrousel-restaurante button");
