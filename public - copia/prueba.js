...
let h3Promo = document.createElement("H3");
...
class restaurante {
    constructor(nombre, srcImgPrincipal, categoria, tipoDeComida, calificacion, srcVideoIntroduccion, arrayImgs, linkMenu){
        ...
        console.log(nombre + "           " + srcImgPrincipal);
        };
    };
...
function pegarPromo() {
    ...
    contenedorBtnInfo = document.createElement("DIV");
    contenedorBtnInfo.classList.add("contenedor-btn");
    btnInfo = document.createElement("A");
    txtBtnInfo = document.createTextNode("Más Información");
    contenedorPromo.appendChild(contenedorBtnInfo);
    contenedorBtnInfo.appendChild(btnInfo);
    btnInfo.appendChild(txtBtnInfo);
    btnInfo.href = "restaurante seleccionado.html";
...
function remplazarPromo() {
    ...
    contenedorPromo.removeChild(contenedorBtnInfo);
